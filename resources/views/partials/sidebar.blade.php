<aside id="sidebar-wrapper">
    <div class="sidebar-brand">
        <a href="{{ route('user.dashboard') }}">HRIS</a>
    </div>
    <div class="sidebar-brand sidebar-brand-sm">
        <a href="{{ route('user.dashboard') }}">HR</a>
    </div>
    <ul class="sidebar-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    @can('karyawan.create')
                        <li class="{{ request()->routeIs('karyawan.create') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('karyawan.create') }}">
                                Tambah Karyawan
                            </a>
                        </li>
                    @endcan
        ...
        <li class="dropdown {{ request()->routeIs('Kehadiran.*') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                @endcan
                <li class="nav-item {{ request()->routeIs('kehadiran.*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('kehadiran.kehadiran-saya') }}">
        ...
        @canany(['divisi.read', 'divisi.create'])
            <li class="dropdown {{ request()->routeIs('divisi.*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    @endcan
                    @can('divisi.create')
                        <li class="{{ request()->routeIs('divisi.create') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('divisi.create') }}">Buat Divisi</a>
                        </li>
                    @endcan
                </ul>
            </li>
        ...
        <li class="dropdown {{ request()->routeIs('cuti.*') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                @can('cuti.read')
                    <li class="{{ request()->routeIs('cuti.index') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('cuti.index') }}">Cuti</a>
                    </li>
                @endcan
                <li class="{{ request()->routeIs('cuti.show') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('cuti.show') }}">Cuti Saya</a>
                </li>
                <li class="{{ request()->routeIs('cuti.create') ? 'active' : '' }}">
